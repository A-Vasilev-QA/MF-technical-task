...
### Priority 3
- **Получение пользвателя по /get?username** - не описано в спецификации, иначе приоритет был бы выше
- **Получение пользвателя по /get?email** - не описано в спецификации, иначе приоритет был бы выше
